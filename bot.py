...
# ──────────────────────────────────────────────
SUITS = [
    {"sym": "♥️", "name": "Классические отжимания", "emoji": "💪", "tip": "Делаешь классические отжимания,Локти вдоль тела!"},
    {"sym": "♠️", "name": "Широкий хват",           "emoji": "🦅", "tip": "Широким хватом.Руки шире плеч!"},
    {"sym": "♦️", "name": "Алмазные (узкий хват)",  "emoji": "💎", "tip": "Алмазные отжимания.Руки максимально близко и ромбом!"},
    {"sym": "♣️", "name": "Взрывные (с хлопком)",   "emoji": "💥", "tip": "С хлопками взрывной толчок!"},
]
